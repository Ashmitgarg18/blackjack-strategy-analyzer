...
export default function Simulate() {
  ...
  return (
    <div className="space-y-8">
      {/* Title */}
      <div>
        <h2 className="text-2xl font-semibold mb-2">Simulation</h2>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Penetration</label>
            <input
              type="number"
              step="0.05"
              min="0.1"
      ...
      {running && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <p className="mb-2 text-sm font-medium">Running Simulation...</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 space-y-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              ...
              <p className="text-lg font-medium">{result.ev}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">ROI</p>
              <p className="text-lg font-medium">{result.roi}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Hands Played
              </p>
              <p className="text-lg font-medium">{result.handsPlayed}</p>
            </div>
            <div>
